...
import com.ch4k4uw.oauthdddlogin.domain.security.builder.SimpleUserEntityBuilder
import javax.inject.Inject

class SimpleUserEntityBuilderFactory @Inject constructor(private val companyFactory: SecurityValueFactory):
    UserEntityBuilderFactory {
