package com.ch4k4uw.oauthdddlogin.domain.security.builder
...
class SimpleUserEntityBuilder(private val id: Long, private val companyFactory: SecurityValueFactory):
    UserEntityBuilder {
    ...
    override fun build(): UserEntity = SimpleUserEntity(id, name ?: "", email ?: "", photo ?: "", password ?: "", company ?:  companyFactory.newEmptyCompany())
